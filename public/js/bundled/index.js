...
},{"./login.js":"7yHem","@babel/polyfill":"dTCHC","./mapbox.js":"3zDlz"}],"7yHem":[function(require,module,exports) {
...
const login = async (email, password)=>{
    try {
        const res = await (0, _axiosDefault.default).post("http://localhost:3000/api/v1/users/login", {
            email,
            password
        });
...
const logout = async ()=>{
    try {
        const res = await (0, _axiosDefault.default).get("http://localhost:3000/api/v1/users/logout");
        console.log(res);
...
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "hidingAlert", ()=>hidingAlert);
...
const displayMap = (locations)=>{
    mapboxgl.accessToken = "pk.eyJ1IjoicmlhZGRldiIsImEiOiJjbTM0NWx0eTAxb2wzMmlzODZzeXo1c3h1In0.fCfh11o_mXvMU8gR59MmKQ";
